...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
            ...
            : Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        ...
                        fit: BoxFit.fill)),
                child: Opacity(opacity: 0.3, child: Image.file(_image as File))),
      ));
    } else {
      stackChildren.add(Positioned(
        top: 0.0,
        left: 0.0,
        width: size.width,
        child: _image == null ? Text('No image selected.') : Image.file(_image as File),
      ));
    }
    ...
    if (_model == mobile) {
      ...
      stackChildren.addAll(renderBoxes(size) as Iterable<Widget>);
